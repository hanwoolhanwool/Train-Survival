...
**프로젝트 시작 2026.07 · 개발 기 2026.07 ~ 2027.01 · 2027.02 초 출시 목표**
...
| 항목 | 규모 |
|---|---|
| 코드 | C# 스크립트 322개 · 43,913줄 |
| 테스트 | EditMode 743개 (테스트 파일 71개) |
| 어셈블리 | 런타임 6개 + 테스트 2개 — 의존 방향 단방향 고정 |
| 문서 | 기획서 · 네트워크 아키텍처 · 세계관 · 비주얼/UIUX · 오디오 · 아트 예산 |
| 마일스톤 | M1~M5 완료 · M6~M8 진행 중 |

<sub> 개발이 진행 중이라 수치는 계속 바뀐다.
