...
| `NightAmbientTemperature` | 15 ℃ | 9 ℃ | 사막 밤은 2 ℃였으나 확정 사망이라 9 ℃로 조정 (2026-08-03) — 난방 수단(M5) 도입 시 되돌림 |
...
| 사막 밤 온도 9 ℃ | 임시 밸런스 (2026-08-03) — 밤 추위 대응 수단(난방 건축물·방한 장비, M5) 도입 시 급랭 값으로 되돌림 |
