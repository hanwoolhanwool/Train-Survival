// 벤더링 (M6 2차 결정 ①) — Unity multiplayer-community-contributions의
// com.community.netcode.transport.steamnetworkingsockets 1.0.1 (Heathen Group, MIT —
// TRANSPORT-LICENSE.md), 커밋 d862504 기준. NGO 2.13에서 우리가 직접 수선·유지한다.
// 원본 대비 변경: 조건부 컴파일을 원본 패키지의 versionDefines(STEAMWORKSNET 등) 대신
// !DISABLESTEAMWORKS 단독 가드로 교체 (두 의존성은 이 프로젝트에 상시 존재).
