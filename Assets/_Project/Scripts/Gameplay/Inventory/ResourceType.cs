namespace Game.Gameplay.Inventory
{
    ...
    public enum ResourceType : byte
    {
        ...
        /// <summary>
        /// 생선 — 바다 (바다 지역 3차, 기획서 §4 확장). 비연료·비건자재. 화덕 요리 재료다.
        /// <b>바다에서는 채집이 낚시로 바뀐다</b> — 궤도 밖이 전부 물이라 땅에서 캘 것이 없다.
        /// <para>이 값으로 <b>원자재 대역(0~15)에 한 칸만 남는다.</b> 종류별 분화(고등어/심해어)는
        /// 여기서 더 늘리지 말고 별도 카탈로그로 풀어야 한다.</para>
        /// </summary>
        Fish = 14,
